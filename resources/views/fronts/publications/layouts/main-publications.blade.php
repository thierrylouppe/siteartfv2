				...
				<aside class="sidebar">
					<div class="px-3 mt-4">
						...
						<ul class="mt-2 mb-0 nav nav-list flex-column p-relative right-9">
							...
							<li class="nav-item"><a class="nav-link bg-transparent border-0 {{ request()->url()==route('publications.bulletins-regulateur') ? 'active' : '' }}" href="{{ route('publications.bulletins-regulateur') }}">Bulletins du régulateur</a></li>
