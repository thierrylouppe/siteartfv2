			...
			<div class="mb-5 border-0 card border-radius-0 box-shadow-1">
				<div class="p-4 card-body z-index-1">
					...
					<div class="p-0 card-body">
						...
						<hr class="my-3">
						@foreach($bulletinregulateurs as $bulletinregulateur)
						<section class="mb-5 call-to-action featured featured-primary">
							...
							<div class="col-sm-3 col-lg-3">
								<div class="call-to-action-btn">
									<a href="{{asset('storage/'.$bulletinregulateur->file)}}" download="{{$bulletinregulateur->title}}.pdf" target="_blank" class="btn btn-modern text-2 btn-primary">Télécharger <span><i class="fas fa-file-pdf"></i></span></a>
								</div>
							</div>
						</section>
						@endforeach
