			...
			<div class="row">
				...
				<div class="order-1 col-md-4 order-md-2 align-self-center">
					<ul class="breadcrumb d-block text-md-right">
						...
						<li class="active "><a class="text-color-light">Circulaires</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="mb-5 border-0 card border-radius-0 box-shadow-1">
				<div class="p-4 card-body z-index-1">
					...
					<div class="p-0 card-body">
						<h2 class="mt-2 font-weight-bold">CIRCULAIRES </h2>
						<hr class="my-3">
						@if($nbrecirculaires > 0)
						@forelse($circulaires as $circulaire)
						<section class="mb-5 call-to-action featured featured-primary">
							<div class="col-sm-9 col-lg-9">
								<div class="call-to-action-content">
									<h3><strong class="font-weight-extra-bold">{{$circulaire->titre}}</strong></h3>
								</div>
							</div>
							<div class="col-sm-3 col-lg-3">
								<div class="call-to-action-btn">
									<a href="{{asset('storage/'.$circulaire->pathfichier)}}" download="{{$circulaire->titre}}.pdf" target="_blank" class="btn btn-modern text-2 btn-primary">Télécharger <span><i class="fas fa-file-pdf"></i></span></a>
								</div>
							</div>
						</section>
						@empty
