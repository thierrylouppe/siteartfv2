		    <!-- Footer -->
		    <footer id="footer" class="custom-footer bg-color-footer m-0">
		    	<div class="container py-8">
		    		<div class="row text-center text-lg-left pt-5 pb-4">
		    			<div class="col-md-1 mb-4 mb-lg-0">
		    				<a href="#" class="text-decoration-none">
		    					<img src="assets/img/logo/logoFooter.png"  class="img-fluid  img-thumbnail-no-borders rounded-0"   alt />
		    				</a>
		    			</div>
		    			<div class="col-md-3 mb-4 mb-lg-0">
		    				<h5 class="text-color-light font-weight-bold mb-2">Contact</h5>
		    				<ul>
		    					<li>
		    			...
		    			<div class="col-md-2 mb-4 mb-lg-0">
		    				<h5 class="text-color-light font-weight-bold mb-1">Liens utiles</h5>
		    				<ul>
		    			...
		    			<div class="col-md-4 mb-4 mb-lg-0">
		    				<h5 class="text-color-light font-weight-bold mb-1">News letter</h5>
		    	...
		    	<div class="footer-copyright bg-color-footer m-0 pt-3 pb-3">
		    		<div class="container">
		    ...
		    <!--  -->
		    <script src="{{asset('assets/js/slider/slider.js')}}"></script>
